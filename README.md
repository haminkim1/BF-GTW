...
2. Clone the repo
   ```sh
   git clone https://github.com/haminkim1/BF-GTW.git
   ```
...
See the [open issues](https://github.com/haminkim1/BF-GTW/issues) for a full list of proposed features (and known issues).
...
Your Name - [@twitter_handle](https://twitter.com/twitter_handle) - hakimnz1997@gmail.com
